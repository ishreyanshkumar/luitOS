...
#define PTE_A (1L << 6)
#define PTE_D (1L << 7)
/* Bit 8 is RSW (reserved for supervisor software). We use it for copy-on-write. */
#define PTE_COW (1L << 8)  /* RSW bit, reserved for software: unused in the
                              baseline, claimed by your Lab 5 COW fork */
