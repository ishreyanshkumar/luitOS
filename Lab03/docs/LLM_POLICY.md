> **Lab 3 v1.2 submission note:** The Lab 3 handout and `tools/package_lab03.py` are authoritative for this graded lab. Lab 3 submits exactly `kernel/usysinfo.c` and `user/ulib.c`; do **not** add an `LLM_LOG.md` or any other file to the Lab 3 ZIP. The general policy below remains course guidance for other activities.
