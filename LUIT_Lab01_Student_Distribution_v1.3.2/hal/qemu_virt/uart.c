/* L3 - NS16550A UART driver. The ONLY file that knows what a UART register is.
 * Note: no #define UART0 anywhere. The base address is handed to us by the
 * device tree, via hal_console_init(). Move the UART, and this still works. */
#include "types.h"
#include "hal.h"
