/* L2 - THE HARDWARE ABSTRACTION LAYER.
 *
 * This is the contract between the kernel and the board. Every board-specific
 * fact lives behind these functions. RULE, enforced by CI: no file outside
 * hal/ may contain a raw MMIO address. If you need one, it belongs here.
 *
 * Backends: hal/qemu_virt/ (dev), hal/shakti/, hal/vega/ (L16).
 */
#ifndef LUIT_HAL_H
#define LUIT_HAL_H
#include "types.h"
