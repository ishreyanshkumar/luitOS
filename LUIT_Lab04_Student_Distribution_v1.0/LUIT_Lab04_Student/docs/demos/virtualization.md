# Classroom demo: virtualization — "every process thinks it owns the machine"

A live, projector-ready script for the first lecture. Luit demonstrates all
three classical virtualizations: the CPU, memory, and I/O.
...
Chapter 3 (Page tables) of the guide explains the address illusion; Chapter 7
(Scheduling) explains the interleaving.
