...
# Define helpers before connecting to QEMU. This way they are still available
# even if `target remote` fails because QEMU is not running yet.
...
# ---- Connect after helper definitions ------------------------------------
